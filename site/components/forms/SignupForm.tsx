    ...
    return (
        <div className="space-y-4">
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-white text-black hover:bg-gray-200 h-10 px-4 py-2 rounded-md text-sm font-medium transition-colors"
            >
